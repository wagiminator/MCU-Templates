// ===================================================================================
// Basic System Functions for CH32V002, V004, V005, V006, V007, M007          * v0.1 *
// ===================================================================================
//
...
// RST_wasADC()             check if last reset was caused by ADC
// RST_wasOPA()             check if last reset was caused by OPA or CMP
//
...
// PVD_set_1V85()           set detection level to 1.85V falling / 1.87V rising edge
// PVD_set_2V21()           set detection level to 2.21V falling / 2.23V rising edge
// PVD_set_2V41()           set detection level to 2.41V falling / 2.43V rising edge
// PVD_set_2V60()           set detection level to 2.60V falling / 2.66V  rising edge
...
// - OpenWCH: https://github.com/openwch/ch32v002_004_005_006_007
//
...
#define RST_wasADC()      (RCC->RSTSCKR & RCC_ADCRSTF)
#define RST_wasOPA()      (RCC->RSTSCKR & RCC_OPCMRSTF)
...
// ===================================================================================
#define PVD_enable()          {RCC->PB1PCENR |= RCC_PWREN; PWR->CTLR |= PWR_CTLR_PVDE;}
#define PVD_set_1V85()        PWR->CTLR &= ~PWR_CTLR_PLS
#define PVD_set_2V21()        PWR->CTLR  = (PWR->CTLR & ~PWR_CTLR_PLS) | (0b01 << 5)
#define PVD_set_2V41()        PWR->CTLR  = (PWR->CTLR & ~PWR_CTLR_PLS) | (0b10 << 5)
#define PVD_set_2V60()        PWR->CTLR |=  PWR_CTLR_PLS
