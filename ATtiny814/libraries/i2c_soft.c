...
// I2C Delay
// ===================================================================================
#define I2C_DLY_TICKS_H   (((F_CPU *  9) / (I2C_CLKRATE * 25)) - 1)
#define I2C_DLY_TICKS_L   (((F_CPU * 16) / (I2C_CLKRATE * 25)) - 9)
...
void I2C_init(void) {
  ...
  PIN_low(PIN_SCL);                         // preset SCL output value (low)
  PIN_low(PIN_SDA);                         // preset SDA output value (low)
}
