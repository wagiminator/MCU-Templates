// ===================================================================================
// Basic GPIO Functions for STM32L010                                         * v0.1 *
// ===================================================================================
//
...
#define ADC_medium()        ADC1->SMPR  = (ADC->SMPR & ~ADC_SMPR_SMP) | 0b110
...
#define ADC_input_VREF()    ADC1->CHSELR = (uint16_t)1<<17  // set ADC channel 17
